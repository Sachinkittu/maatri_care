...
<?php
   if(isset($_POST['search'])){
    ...
    $sql = "SELECT * FROM patient where PatientName ='$_POST[PatientName]' ";
...
while($row=mysqli_fetch_array($result))
{
  ...
  <div class='card'>
                    <div class='card-body'>
                      ...
                      <form class='form-sample' method='POST' action='patientsearchnameinsert.php'>
...
echo "</select>
            ...
            <button type='reset' class='btn btn-warning mr-2'>Cancel</button>
                      ...
                      <a href='patientsearchname.php'><button style='width:100%;' class='btn btn-warning mr-2'>Back</button></a>
                    </div>
                  </div>";
}
}
