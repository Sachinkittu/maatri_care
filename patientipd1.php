<?php
  ...
  {
    include 'Master.php';
    $sql1 = "SELECT * FROM patient where umrno='$_GET[id]' ";
    $result1=mysqli_query($conn,$sql1);
    $row1 = mysqli_fetch_array($result1);
    $DateOfDischarge = $row1['DateOfDischarge'];
    ...
    if($DateOfDischarge == null)
    {
      ...
      echo "<script>
      function new(){
      window.alert('Patient is already Admitted in a Hospital');      
      }</script>";
      header ("Location:patientipdsearch.php");      
    }
...
<?php
    ...
    $sql = "SELECT * FROM patient where umrno='$_GET[id]' ";
    $result=mysqli_query($conn,$sql);
    

while($row=mysqli_fetch_array($result))
{
echo "<form action='patientipd1insert.php' method='POST'>
<!---------------------------Nav bar-------------------------------------------------->
<div class='row'>
					  ...
					  <div class='row'>
                        ...
                        <div class='col-md-6'>
                          <div class='form-group row'>
                            ...
                            <div class='col-sm-9'>
                             <select class='form-control' name='ward1'>
                            <option selected>".$row['ward1']."</option>";
                        ...
                        <div class='row'>
                         <div class='col-md-6'>
                           <div class='form-group row'>
                             ...
                             <div class='col-sm-9'>
                                <input type='text' class='form-control' placeholder='Enter IPD No.' name='IPD1' value='".$row['IPD1']."' />
                             </div>
                           </div>
                         </div>
                         ...
                         <div class='col-md-6'>
                           ...
                           <div class='col-sm-9'>
                              <input type='text' class='form-control' placeholder='Enter Bed No.' name='Bed1' value='".$row['Bed1']."' />
                           </div>
                           </div>
                         </div>
                       </div>
                       <div class='row'>
                         <div class='col-md-6'>
                           <div class='form-group row'>
                             ...
                             <div class='col-sm-9'>
                             <input type='date' class='form-control' placeholder='dd/mm/yyyy' name='DateOfAdmission1' value='".$row['DateOfAdmission1']."' />
                           </div>
                           </div>
                         </div>
                         ...
                         <div class='form-group row'>
                           ...
                           <div class='col-sm-9'>
                              <input type='text' class='form-control' placeholder='Enter Remark' name='remarkipd1' value='".$row['remarkipd1']."' />
                           </div>
                         </div>
                       </div>
                       </div>
                       <div class='row'>
                       <div class='col-md-12'>
                        <label class='col-sm-12 col-form-label'>If the Patient is already admitted once then <a href='patientipd.php?id=".$row['umrno']."'>click here</a> for its next admission details</label>
                       </div>
