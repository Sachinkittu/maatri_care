...
if(isset($_POST['submit'])){
	...
	// 	$DateOfNinth = $_POST['DateOfNinth'];
		...
		$IPD1 = $_POST['IPD1'];
		$Bed1 = $_POST['Bed1'];
		$DateOfAdmission1 = $_POST['DateOfAdmission1'];
		$remarkipd1 = $_POST['remarkipd1'];
	...
	$sql = "UPDATE patient set ward1 = '$ward1',
								IPD1 = '$IPD1',
								Bed1 = '$Bed1',
								DateOfAdmission1 = '$DateOfAdmission1',
								remarkipd1 = '$remarkipd1' where umrno = '$umrno' ";
