...
{
echo "<form action='childdischargeinsert.php' method='POST'>
<!-------------------------------------------------------------------------------------->
<div class='row'>
                      ...
                      <div class='row'>
                        <div class='col-md-6'>
                          <div class='form-group row'>
                            ...
                            <div class='col-sm-9'>
                               <input type='text' class='form-control' placeholder='Enter baby name' name='babyname' disabled value='".$row['babyname']."'  >
                            </div>
                          </div>
                        </div>
                        <div class='col-md-6'>
                          <div class='form-group row'>
                            ...
                            <div class='col-sm-9'>
                            <input type='date' class='form-control' placeholder='dd/mm/yyyy' name='DateOfDelivery' disabled value='".$row['DateOfDelivery']."'>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class='row'>
                        <div class='col-md-6'>
                          <div class='form-group row'>
                            ...
                            <div class='col-sm-9'>
                            <input type='text' class='form-control' placeholder='Gender' name='Gender' disabled value='".$row['Gender']."'>
                              </div>
                          </div>
                        </div>
                        <div class='col-md-6'>
                          <div class='form-group row'>
                            ...
                            <div class='col-sm-9'>
                            <input type='text' class='form-control' placeholder='Mother's Name' name='MotherName' disabled value='".$row['MotherName']."'>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class='row'>
                        <div class='col-md-6'>
                          <div class='form-group row'>
                            ...
                            <div class='col-sm-9'>
                            <input type='text' class='form-control' placeholder='Father's Name' name='FatherName' disabled value='".$row['FatherName']."'>
                            </div>
                          </div>
                        </div>
                        <div class='col-md-6'>
