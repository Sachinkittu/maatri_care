...
if(isset($_POST['submit'])){
	...
	$DateOfDiscahrge = $_POST['DateOfDischarge'];
	...
	$sql = "UPDATE patient SET	ChildHeartbeat = '$ChildHeartbeat',
								LMP = '$LMP',
								EDD = '$EDD',
								Scheme = '$Scheme',
								ward = '$ward',
								...
								remark9 = '$remark9',
								DateOfNinth = '$DateOfNinth' where umrno = '$umrno' ";
	$result=mysqli_query($conn,$sql);
	

    if($result)
	{
        header("Location:patientsearchname.php");
    }
    else
    {
